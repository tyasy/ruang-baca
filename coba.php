	...
	<div class="mainpage row" style="padding: 0px 50px">
		<div class="col-md-12" style="margin-bottom: 60px;">
			...
			<div class="booksWrapper grid-item">
				<ul>
				<?php
				 $con=mysqli_connect("localhost","root","","ruangbaca");
				  $query=mysqli_query($con,"SELECT * FROM buku");
				  while($data=mysqli_fetch_array($query)){?>
					<li>
						<div class="displayBuku small2">
							<img src=<?php echo $data['filegambar'] ?> align="center">
							<div class="book-detail">
								<div class="book-name"><?php echo $data['judul'] ?></div>
								<div class="book-author"><?php echo $data['penulis'] ?></div>
								<div class="book-owner">Pemilik buku: <span><?php echo $data['username'] ?></span> - <span>Jakarta</span></div>
								<div class="book-price"><span class="harga"><?php echo $data['hargasewa'] ?></span><button type="button" class="btn add-to-cart"><i class="glyphicon glyphicon-plus"></i><i class="glyphicon glyphicon-shopping-cart"></i></button></div>
							</div>
						</div>
					</li>
					<li>
