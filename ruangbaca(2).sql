...
--
-- Host: localhost
-- Generation Time: Nov 04, 2017 at 08:02 PM
...
INSERT INTO `giveaway` (`idgiveaway`, `username`, `isigiveaway`, `status`, `tanggalinput`, `filegambar`) VALUES
(1, 'nasalsabila', 'Halo, teman-teman!\r\nAku Sabila, mau bagi satu buku Happy Little Soul untuk semua #TemanMainKirana. Siapa cepat dia dapat!', 'Tersedia', '2017-11-04 12:23:09', 'happylittlesoul.JPG'),
(2, 'tyasyuni', 'Hey! Buku Rectoverso untuk yang beruntung! Silakan~', 'Tersedia', '2017-11-04 12:23:15', 'rectoverso.JPG');
